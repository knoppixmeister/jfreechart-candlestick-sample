...
public class DifferenceChartDemo1 extends ApplicationFrame {
	private static final long serialVersionUID = 5671872175892661438L;
    ...
    public DifferenceChartDemo1(String title) {
        ...
        chartPanel.setPreferredSize(new java.awt.Dimension(1500, 570));
    ...
    public static void main(String[] args) {
        DifferenceChartDemo1 demo = new DifferenceChartDemo1("JFreeChart: DifferenceChartDemo1.java");
        demo.pack();
