...
public class MultipleAxisDemo1 extends ApplicationFrame {
	private static final long serialVersionUID = 1064685233438063709L;
    ...
    private static JFreeChart createChart() {
        ...
        //plot.getRangeAxis().setFixedDimension(15);
    ...
    public static void main(String[] args) {
        MultipleAxisDemo1 demo = new MultipleAxisDemo1("JFreeChart: MultipleAxisDemo1.java");
        demo.pack();
