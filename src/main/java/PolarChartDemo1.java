...
public class PolarChartDemo1 extends ApplicationFrame {
	private static final long serialVersionUID = -1326863678261992910L;
	...
	private static JFreeChart createChart(XYDataset dataset) {
		JFreeChart chart = ChartFactory.createPolarChart("Polar Chart Demo 1", dataset, true, false, false);
    ...
    public static void main(String[] args) {
        PolarChartDemo1 demo = new PolarChartDemo1("JFreeChart: PolarChartDemo1.java");
        demo.pack();
