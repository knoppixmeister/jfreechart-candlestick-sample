...
public class CrossSectionDemo1 extends ApplicationFrame {
	private static final long serialVersionUID = -6580484725442719218L;
	...
	static class MyDemoPanel extends DemoPanel implements ChangeListener, ChartChangeListener {
        ...
        public MyDemoPanel() {
            ...
            this.crosshair1 = new Crosshair(0);
            this.crosshair1.setPaint(Color.BLACK);
            this.crosshair2 = new Crosshair(0.0);
            this.crosshair2.setPaint(Color.blue);
            this.crosshair2.setLabelAnchor(org.jfree.chart.ui.RectangleAnchor.BOTTOM_RIGHT);
            ...
            this.crosshair1.setLabelAnchor(org.jfree.chart.ui.RectangleAnchor.TOP_RIGHT);
            ...
            this.subchart1 = ChartFactory.createXYLineChart("Cross-section A", "Y", "Z", dataset1, PlotOrientation.HORIZONTAL, false, false, false);
            ...
            this.subchart2 = ChartFactory.createXYLineChart("Cross-section B", "X",  "Z", dataset2, PlotOrientation.VERTICAL, false, false, false);
        ...
        public void stateChanged(ChangeEvent e) {
            if(e.getSource() == this.slider1) {
            	System.out.println("SL1: "+slider1.getValue());
        ...
        private JFreeChart createChart(XYDataset dataset) {
            ...
            plot.getRenderer().addAnnotation(ann, org.jfree.chart.ui.Layer.BACKGROUND);
