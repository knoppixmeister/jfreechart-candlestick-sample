...
public class MarkerDemo1 extends ApplicationFrame {
    ...
    private static JFreeChart createChart(XYDataset data) {
        ...
        start.setLabelOffsetType(org.jfree.chart.ui.LengthAdjustmentType.EXPAND);
        start.setPaint(Color.BLACK);
        start.setLabel("Bid Start Price 111");        
        start.setLabelAnchor(org.jfree.chart.ui.RectangleAnchor.BOTTOM_RIGHT);
        start.setLabelTextAnchor(org.jfree.chart.ui.TextAnchor.TOP_RIGHT);
