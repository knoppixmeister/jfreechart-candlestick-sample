...
public class CrosshairDemo3 extends ApplicationFrame {
	private static final long serialVersionUID = 577964509528004358L;

	static class MyDemoPanel extends DemoPanel implements ChangeListener {
		private static final long serialVersionUID = 691405128960737314L;
	...
	public static void main(String[] args) {
		CrosshairDemo3 demo = new CrosshairDemo3("JFreeChart: CrosshairDemo3.java");
        demo.pack();
