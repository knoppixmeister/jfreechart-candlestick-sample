...
public class OHLCSeriesCollection extends AbstractXYDataset implements OHLCDataset, Serializable {
	private static final long serialVersionUID = 6869911017546496601L;
    ...
    public boolean equals(Object obj) {
        ...
        if(!(obj instanceof OHLCSeriesCollection)) return false;

        OHLCSeriesCollection that = (OHLCSeriesCollection) obj;
        if(!xPosition.equals(that.xPosition)) return false;
