...
public class MouseOverDemo1 extends ApplicationFrame {
	private static final long serialVersionUID = -8536779178271433043L;

    static class MyBarRenderer extends BarRenderer {
		private static final long serialVersionUID = 1032100843979164949L;
        ...
        public void setHighlightedItem(int r, int c) {
            if(highlightRow == r && highlightColumn == c) {
    ...
    public static void main(String[] args) {
        MouseOverDemo1 demo = new MouseOverDemo1("JFreeChart: MouseoverDemo1.java");
        demo.pack();
